    ...
    <div className="w-64 bg-[#0f172a] text-slate-400 flex flex-col min-h-screen fixed left-0 top-0 shadow-xl border-r border-slate-800/50 font-medium">
      ...
      <div className="p-4 border-t border-slate-800/50 space-y-2">
        ...
        <button 
          ...
          className="w-full flex items-center gap-3 px-4 py-2 text-red-400/70 hover:text-red-400 hover:bg-red-400/5 rounded-lg transition-all text-[10px] uppercase tracking-widest"
        >
          <LogOut size={14} />
          Sign Out
        </button>
