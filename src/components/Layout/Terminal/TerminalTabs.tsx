    ...
    return (
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-white/[0.1] scrollbar-track-transparent">
            <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-xl border font-bold text-[10px] uppercase tracking-widest transition-all whitespace-nowrap ${activeTabId === 'new'
            ...
            {sessions.map((session) => (
                <div
                    ...
                    className={`group flex items-center gap-3 px-5 py-3 rounded-xl border font-bold text-[10px] uppercase tracking-widest transition-all whitespace-nowrap cursor-pointer ${activeTabId === session.id
