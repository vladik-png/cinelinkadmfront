                                ...
                                <tr key={`skeleton-${idx}`} className="border-b border-white/[0.03]">
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="h-4 w-40 bg-white/[0.05] animate-pulse rounded"></div>
                                        </div>
                                    </td>
                                    <td className="py-4 px-6">
                                        <div className="flex flex-col gap-2">
                                    ...
                                    <td className="py-4 px-6 text-right"><div className="h-8 w-8 bg-white/[0.05] animate-pulse rounded ml-auto"></div></td>
                                </tr>
                            ))
                        ) : (
                            users.map((user) => {
