...
export const ServerProblemsHeader: React.FC = () => {
    return (
        <div className="flex justify-between items-end border-b border-white/[0.05] pb-6 mb-6">
            <div>
                <h1 className="text-3xl tracking-wide uppercase font-bold leading-none bg-gradient-to-r from-[#f1416c] to-[#ffa800] bg-clip-text text-transparent">Server Problems</h1>
