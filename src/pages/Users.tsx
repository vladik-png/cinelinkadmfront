            ...
            <div className="px-8 pb-8">
              ...
              <div className="flex flex-col gap-3 pt-6 border-t border-white/[0.05]">
                <button
                  ...
                  className={`w-full py-4 rounded-xl text-xs font-black uppercase tracking-widest transition-all flex items-center justify-center gap-3 ${selectedUser.is_active
