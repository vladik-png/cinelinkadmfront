          ...
          {servers.map((server) => {
            ...
            return (
              <div 
                ...
                className={`cursor-pointer bg-white rounded-[1.5rem] border shadow-sm p-8 hover:shadow-md hover:scale-[1.02] transition-all border-t-2 ${isWindows ? 'border-t-indigo-500/50' : 'border-t-orange-500/50'}`}
              >
